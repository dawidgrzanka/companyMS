    ...
    <div class="container">
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                ...
                <input type="number" id="purchase_price_brutto" name="purchase_price_brutto" class="form-control" step="0.01" value="{{ old('purchase_price_brutto', $product->purchase_price_brutto) }}" required readonly>
            </div>
            <div class="col-md-6">
                <label for="sale_price_netto" class="form-label">Cena sprzedaży netto</label>
                <input type="number" id="sale_price_netto" name="sale_price_netto" class="form-control" step="0.01" value="{{ old('sale_price_netto', $product->sale_price_netto) }}" required readonly>
            </div>
        </div>
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                ...
                <input type="number" id="sale_price_brutto" name="sale_price_brutto" class="form-control" step="0.01" value="{{ old('sale_price_brutto', $product->sale_price_brutto) }}" required readonly>
            </div>
            <div class="col-md-6">
