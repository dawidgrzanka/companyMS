            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" class="flex items-center">
                        ...
                        <span class="ml-2 text-s font-semibold text-gray-800">companyMS</span>
                    </a>
                </div>
                    ...
                    <div class="hidden sm:flex sm:items-center sm:ml-6 pt-1">
                        <x-dropdown align="right" width="48">
                            ...
                            <x-slot name="content">
                                ...
                                <x-dropdown-link :href="route('products.create')" active="request()->routeIs('permissions')">
                                    {{ __('Dodaj materiał') }}
                                </x-dropdown-link>
                                <x-dropdown-link :href="route('products.low_stock')" active="request()->routeIs('products.low_stock')">
                                    {{ __('Niskie Stany Magazynowe') }}
                                </x-dropdown-link>
                            </x-slot>
                        </x-dropdown>
                    </div>
