    ...
    public function store(Request $request)
{
    ...
    try {
        ...
        return redirect()->route('expenses.index')->with('success', 'Wydatek został zapisany pomyślnie.');
    } catch (\Exception $e) {
        DB::rollback();  // Wycofanie transakcji w przypadku błędu
        Log::error('Błąd przy zapisie wydatku: ' . $e->getMessage());
        return back()->with('error', 'Wystąpił błąd podczas zapisywania wydatku. Proszę spróbować ponownie.');
    }
}
